...
/// 转盘的奖池说明
class ZhuanPanShuoMingPage extends StatefulWidget {
  const ZhuanPanShuoMingPage({super.key});

  @override
  State<ZhuanPanShuoMingPage> createState() => _ZhuanPanJiangChiPageState();
}

class _ZhuanPanJiangChiPageState extends State<ZhuanPanShuoMingPage> {
  @override
  void initState() {
