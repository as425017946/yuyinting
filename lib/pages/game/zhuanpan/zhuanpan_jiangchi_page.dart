...
/// 转盘的奖池
class ZhuanPanJiangChiPage extends StatefulWidget {
  const ZhuanPanJiangChiPage({super.key});

  @override
  State<ZhuanPanJiangChiPage> createState() => _ZhuanPanJiangChiPageState();
}

class _ZhuanPanJiangChiPageState extends State<ZhuanPanJiangChiPage> {
  // 钥匙数量
  int nums = 0;
  var listen;
  @override
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              const Spacer(),
              WidgetUtils.showImages('assets/images/zhuanpan_jc_ys1.png', 20.h, 20.h),
          ...
          GestureDetector(
            onTap: ((){
              MyUtils.goTransparentPageCom(
                  context, DuiHuanQueRenPage(goodsId: list[i].goodsId.toString(), goodsType: list[i].goodsType.toString(), exchangeCost: list[i].exchangeCost!, title: '心动转盘'));
            }),
            child: Stack(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              WidgetUtils.showImages('assets/images/zhuanpan_jc_ys1.png', 32.h, 32.h),
                ...
                //标题
                WidgetUtils.showImages('assets/images/zhuanpan_jc_title1.png', 32.h, 320.h),
