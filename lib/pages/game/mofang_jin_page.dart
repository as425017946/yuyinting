...
class _MofangJinPageState extends State<MofangJinPage>
  ...
  void initState() {
    ...
    if (sp.getString('mf2_queren_time') == null ||
        sp.getString('mf2_queren_time') != time) {
                        ...
                        child: Stack(
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: WidgetUtils.showImages(
                                  'assets/images/mofang_jin_showbg.png',
                                  500.h,
                                  500.h),
                            ),
                            Opacity(
                            ...
                            GestureDetector(
                              onTap: (() {
                                ...
                                if (sp.getBool('mf2_queren') == null ||
                                    sp.getBool('mf2_queren') == false) {
        ...
        case MyHttpConfig.successCode:
          ...
          if (isTiaoguo) {
            ...
            MyUtils.goTransparentPageCom(context,
                MoFangDaoJuPage(list: list, zonge: zonge, title: '金星魔方'));
          } else {
          ...
          if (bean.data!.curType == 1) {
            if (double.parse(jinbi) > 10000) {
              ...
              jinbi = sp.getString('mofangJBY').toString();
              jinbi =
                  (double.parse(jinbi) - int.parse(number) * 200).toString();
              jinbi2 = jinbi;
            }
            sp.setString('mofangJBY', jinbi);
            sp.setString('mofangJB', jinbi2);
            ...
            if (double.parse(zuanshi) > 10000) {
              ...
              zuanshi = sp.getString('mofangZSY').toString();
              zuanshi =
                  (double.parse(zuanshi) - int.parse(number) * 200).toString();
              zuanshi2 = zuanshi;
            }
            sp.setString('mofangZSY', zuanshi);
            sp.setString('mofangZS', zuanshi2);
