              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    ...
                    '2.本游戏可用金蘑菇/V豆参与，货币自动付款顺序为金蘑菇充足时先行消耗金蘑菇，不够时消耗V豆。\n'
                    '比赛获胜后，获得相应数量的金蘑菇奖励。（价值：1金蘑菇=1 V豆）。金蘑菇可在游戏页面的[商店]兑换背包礼物。\n\n'
                    ...
                    '4）幸运七玩法：7号白灵所在的赛道为幸运赛道，当白灵赢得冠军时猜中的用户将赢得12倍奖励，并且平台将返还除白灵外其余所有赛道的用户竞猜本金！\n\n'
                    '4.选择赛道竞猜后，将无法取消！\n'
                    '注意事项：\n'
