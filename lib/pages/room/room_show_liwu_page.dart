...
class _RoomShowLiWuPageState extends State<RoomShowLiWuPage>  with TickerProviderStateMixin {
  //麦位以外人员使用
  ...
  void initState() {
    ...
    final Animatable<double> opacityTween1 = Tween<double>(begin: 1.0, end: 0.0);
    ...
    final Animatable<double> opacityTween2 = Tween<double>(begin: 1.0, end: 0.0);
    ...
    final Animatable<double> opacityTween3 = Tween<double>(begin: 1.0, end: 0.0);
    ...
    final Animatable<double> opacityTween4 = Tween<double>(begin: 1.0, end: 0.0);
    ...
    final Animatable<double> opacityTween5 = Tween<double>(begin: 1.0, end: 0.0);
    ...
    final Animatable<double> opacityTween6 = Tween<double>(begin: 1.0, end: 0.0);
    ...
    final Animatable<double> opacityTween7 = Tween<double>(begin: 1.0, end: 0.0);
    ...
    final Animatable<double> opacityTween8 = Tween<double>(begin: 1.0, end: 0.0);
    ...
    final Animatable<double> opacityTween10 = Tween<double>(begin: 1.0, end: 0.0);
    ...
    for(int i = 0; i < widget.listPeople.length; i++){
      LogE('第$i个状态${widget.listPeople[i]}');
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Stack(
          children: [
            widget.listPeople[8] ? AnimatedBuilder(
            ...
            widget.listPeople[0] ? AnimatedBuilder(
            ...
            widget.listPeople[1] ? AnimatedBuilder(
            ...
            widget.listPeople[2] ? AnimatedBuilder(
            ...
            widget.listPeople[3] ? AnimatedBuilder(
            ...
            widget.listPeople[4] ? AnimatedBuilder(
            ...
            widget.listPeople[5] ? AnimatedBuilder(
            ...
            widget.listPeople[6] ? AnimatedBuilder(
            ...
            widget.listPeople[7] ? AnimatedBuilder(
            ...
            widget.listPeople[9] ? AnimatedBuilder(
