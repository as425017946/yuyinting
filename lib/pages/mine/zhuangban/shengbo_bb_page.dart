...
/// 头像框
class ShengBoBBPage extends StatefulWidget {
  const ShengBoBBPage({Key? key}) : super(key: key);

  @override
  State<ShengBoBBPage> createState() => _ShengBoBBPageState();
}

class _ShengBoBBPageState extends State<ShengBoBBPage>  with AutomaticKeepAliveClientMixin{
  /// 刷新一次后不在刷新
  @override
