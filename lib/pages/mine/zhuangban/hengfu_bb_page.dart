...
/// 头像框
class HengfuBBPage extends StatefulWidget {
  const HengfuBBPage({Key? key}) : super(key: key);

  @override
  State<HengfuBBPage> createState() => _HengfuBBPageState();
}

class _HengfuBBPageState extends State<HengfuBBPage>  with AutomaticKeepAliveClientMixin{
  /// 刷新一次后不在刷新
  @override
