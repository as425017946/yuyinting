...
/// 头像框
class HeadBBPage extends StatefulWidget {
  const HeadBBPage({Key? key}) : super(key: key);

  @override
  State<HeadBBPage> createState() => _HeadBBPageState();
}

class _HeadBBPageState extends State<HeadBBPage>  with AutomaticKeepAliveClientMixin{
  /// 刷新一次后不在刷新
  @override
