...
/// 主播分瑞比例
class HZFenRunPage extends StatefulWidget {
  String name;
  String id;
  String ghID;
  int index;
  ...
  @override
  State<HZFenRunPage> createState() => _HZFenRunPageState();
}

class _HZFenRunPageState extends State<HZFenRunPage> {
  ...
  Future<void> doPostSetRatio() async {
    ...
    try {
      ...
      CommonBean bean = await DataUtils.postConsortiaSetRatio(params);
      switch (bean.code) {
  ...
  /// 设置比例二次确认
  Future<void> nextQueren(BuildContext context) async {
    return showDialog(
        context: context,
        builder: (context) {
          return CustomDialog(
