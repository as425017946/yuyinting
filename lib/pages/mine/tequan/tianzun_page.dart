...
class TianZunPage extends StatefulWidget {
  String zhi;
  TianZunPage({Key? key, required this.zhi}) : super(key: key);

  @override
  State<TianZunPage> createState() => _TianZunPageState();
}

class _TianZunPageState extends State<TianZunPage>  with TickerProviderStateMixin {
  /// 会重复播放的控制器
      ...
      children: [
        Row(
          ...
          children: [
            ...
            GestureDetector(
              onTap: ((){
                eventBus.fire(GuizuButtonBack(index: 8, title: '左'));
              }),
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: const SVGASimpleImage(
                    assetsName: 'assets/svga/gz/gz_tianzun.svga',
                  ),
                )
              ],
            ),
            ...
            GestureDetector(
              onTap: ((){
                eventBus.fire(GuizuButtonBack(index: 8, title: '右'));
              }),
