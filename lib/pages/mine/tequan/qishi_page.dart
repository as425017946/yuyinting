...
class _QishiPageState extends State<QishiPage>  with TickerProviderStateMixin {
  /// 会重复播放的控制器
        ...
        Row(
          ...
          children: [
            WidgetUtils.commonSizedBox(0, 15),
             GestureDetector(
               onTap: ((){
                 eventBus.fire(GuizuButtonBack(index: 1, title: '左'));
               }),
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: const SVGASimpleImage(
                    assetsName: 'assets/svga/gz/gz_shangxian.svga',
                  ),
                )
              ],
            ),
            ...
            GestureDetector(
              onTap: ((){
                eventBus.fire(GuizuButtonBack(index: 1, title: '右'));
              }),
