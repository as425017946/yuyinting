...
class _ShenHuangPageState extends State<ShenHuangPage>  with TickerProviderStateMixin {
  /// 会重复播放的控制器
      ...
      children: [
        Row(
          ...
          children: [
            ...
            GestureDetector(
              onTap: ((){
                eventBus.fire(GuizuButtonBack(index: 7, title: '左'));
              }),
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: const SVGASimpleImage(
                    assetsName: 'assets/svga/gz/gz_shenhuang.svga',
                  ),
                )
              ],
            ),
            ...
            GestureDetector(
              onTap: ((){
                eventBus.fire(GuizuButtonBack(index: 7, title: '右'));
              }),
