...
class _DiwangPageState extends State<DiwangPage>  with TickerProviderStateMixin {
  /// 会重复播放的控制器
      ...
      children: [
        Row(
          ...
          children: [
            ...
            GestureDetector(
              onTap: ((){
                eventBus.fire(GuizuButtonBack(index: 6, title: '左'));
              }),
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: const SVGASimpleImage(
                    assetsName: 'assets/svga/gz/gz_shenwang.svga',
                  ),
                )
              ],
            ),
