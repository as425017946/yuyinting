...
class _GongjuePageState extends State<GongjuePage>  with TickerProviderStateMixin {
  /// 会重复播放的控制器
      ...
      children: [
        Row(
          ...
          children: [
            ...
            GestureDetector(
              onTap: ((){
                eventBus.fire(GuizuButtonBack(index: 4, title: '左'));
              }),
            ...
            GestureDetector(
              onTap: ((){
                eventBus.fire(GuizuButtonBack(index: 4, title: '右'));
              }),
