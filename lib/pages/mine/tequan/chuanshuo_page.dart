...
class _ChuanShuoPageState extends State<ChuanShuoPage>  with TickerProviderStateMixin {
  /// 会重复播放的控制器
      ...
      children: [
        Row(
          ...
          children: [
            ...
            GestureDetector(
              onTap: ((){
                eventBus.fire(GuizuButtonBack(index: 9, title: '左'));
              }),
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: const SVGASimpleImage(
                    assetsName: 'assets/svga/gz/gz_chuanshuo.svga',
                  ),
                )
              ],
            ),
