                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      WidgetUtils.onlyText('$length/3', StyleUtils.getCommonTextStyle(color: Colors.black, fontWeight: FontWeight.w600, fontSize: ScreenUtil().setSp(35))),
                  ...
                  Wrap(
                    ...
                    children: List.generate(list.length, (index) => GestureDetector(
                      ...
                      child: WidgetUtils.myContainerZishiying2(
                          ...
                          list_b[index] ? MyColors.homeTopBG : MyColors.f2,
                          list[index].name!,
                          StyleUtils.getCommonTextStyle(
                              color: list_b[index] == false ? Colors.black : Colors.white,
      ...
      switch (bean.code) {
        case MyHttpConfig.successCode:
          ...
          setState(() {
            ...
            for(int i = 0; i < list.length ; i++){
              if(sp.getString('label_id').toString().contains(list[i].id.toString())){
