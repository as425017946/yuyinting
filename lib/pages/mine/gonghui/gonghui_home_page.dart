...
class GonghuiHomePage extends StatefulWidget {
  ...
  GonghuiHomePage({Key? key, required this.kefuUid, required this.kefuAvatar})
      : super(key: key);
          ...
          Future.delayed(const Duration(seconds: 0), () {
            Navigator.of(context).push(PageRouteBuilder(
                ...
                pageBuilder: (context, animation, secondaryAnimation) {
                  return MyKeFuPage(
                      kefuUid: widget.kefuUid, kefuAvatar: widget.kefuAvatar);
                }));
          });
        }
      }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: [
            WidgetUtils.showImages('assets/images/gonghui_jiaru.png',
                ScreenUtil().setHeight(250), double.infinity),
