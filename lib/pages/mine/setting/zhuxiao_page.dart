          ...
          children: [
            ...
            Row(
              children: [
                ...
                WidgetUtils.showImages('assets/images/zhuxiao.jpg',
                    ScreenUtil().setHeight(150), ScreenUtil().setHeight(200)),
                const Expanded(child: Text('')),
              ],
            ),
            WidgetUtils.commonSizedBox(10, 0),
            WidgetUtils.onlyText(
                '对于您将要注销账号的决定，我们感到非常遗憾。',
            ...
            WidgetUtils.onlyText(
                ...
                StyleUtils.getCommonTextStyle(
                    color: Colors.black, fontSize: ScreenUtil().setSp(30))),
            WidgetUtils.onlyText(
                '2.账号中的信息将无法进行恢复，包括但不限于：',
                StyleUtils.getCommonTextStyle(
                    color: Colors.black, fontSize: ScreenUtil().setSp(30))),
            WidgetUtils.onlyText(
                '·账号的个人资料和历史信息（如实名制认证信息、',
                StyleUtils.getCommonTextStyle(
                    color: Colors.black, fontSize: ScreenUtil().setSp(30))),
            WidgetUtils.onlyText(
                '关注信息、收藏信息、账单、礼物墙等）',
            ...
            WidgetUtils.onlyText(
                ...
                StyleUtils.getCommonTextStyle(
                    color: Colors.black, fontSize: ScreenUtil().setSp(30))),
            WidgetUtils.onlyText(
                '·账号绑定的手机号以及所有第三方账号将无法注册新的账号，请慎重选择！',
                StyleUtils.getCommonTextStyle(
                    color: Colors.black, fontSize: ScreenUtil().setSp(30))),
            const Expanded(child: Text('')),
            GestureDetector(
