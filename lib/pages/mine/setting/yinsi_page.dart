    ...
    return Scaffold(
      ...
      body: const SingleChildScrollView(
        ...
        child: Text(
          '隐私协议\n'+
              '特别提示\n'+
              '贵仁昌益由广州云豹信息科技有限公司及其关联公司（以下简称“我们”或“公司”）提供产品运营和服务。我们深知个人信息对您的重要性，并尽全力保护您的个人信息安全可靠。本政策适用于贵仁昌益客户端应用程序、小程序及相关产品服务。\n'+
              '在使用贵仁昌益前，请您务必仔细阅读并透彻理解本政策，特别是以粗体/粗体下划线标识的条款，您应重点阅读，在确认充分理解并同意后使用相关产品或服务。\n'+
              '除本隐私政策外，在特定场景下，我们还会通过即时告知（如弹窗、页面提示、消息提醒）、网页公告等方式，向你说明对应的信息收集目的、范围及使用方式，这些即时告知、网页公告等方式构成本隐私政策的一部分，与本隐私政策具有同等效力。\n'+
              '为便于您快速了解《贵仁昌益隐私政策》 内容，我们将通过 《贵仁昌益隐私政策概要》向您简要、直观地说明我们是如何处理和保护您的个人信息，有关我们对您的个人信息更详细的处理规则，请继续查阅本隐私政策。\n'+
              ...
              '十、联系我们\n'+
              '一、我们如何收集和使用个人信息\n'+
              '贵仁昌益依据法律法规以及遵循正当、合法、必要的原则而收集和使用您的个人信息。\n'+
              '在您使用我们的产品或服务过程中，我们通常会在以下场景收集和使用您的个人信息。\n'+
              '（一）注册、登录\n'+
              '（1）当您注册、登录贵仁昌益账号时，我们会收集您的手机号码和密码，并可能向您发送验证码以验证账号有效性，为注册用户生成云豹账号。请您知悉，我们收集这些信息是为了满足相关法律法规的网络实名制要求，并帮助您生成高效可靠的登录凭证，保护您的账号安全。如果您仅需使用基本的直播、视频浏览服务，您无需注册账号及提供上述信息。\n'+
              '（2）在您登录贵仁昌益账号后，如果您愿意自主额外补充头像、昵称、性别、生日、地区、签名、草稿箱、发布的视频等个人资料，将有助于您获得更为具有社交乐趣的体验，如果您不提供前述信息，不会影响您享受贵仁昌益的基本功能。如果您仅需要使用浏览功能，您也可以选择在不登录且不提供上述信息的情况下进行。\n'+
              '（二）实名认证\n'+
              '在您使用开通直播、申请提现或其他需要实名认证的功能或服务时，根据国家相关法律法规，您需要向我们和提供认证服务的第三方认证机构提供您的真实身份信息以完成实名认证。主要包括以下几类：\n'+
              '（1）当您申请注册为网络直播服务发布者（主播）时，贵仁昌益将根据相关法律规定收集您的真实姓名、身份证件号码进行实名认证，并通过您的面部识别信息进行身份一致性核验。如您选择人工认证方式完成实名认证，我们可能收集您的真实姓名、身份证件信息（包括但不限于身份证件号码、相应证件的正反面图片和您手持相应身份证件的照片）。通过实名认证后，您方可在平台上从事直播发布活动。如果您有主播佣金提现需求，您还需要提供与您身份信息一致的银行卡信息。为了准确验证您的身份，我们将对上述信息进行比对核验。您的真实姓名、身份证件信息、面部识别信息、手持身份证件照片和银行卡信息属于个人敏感信息，我们收集该类信息是基于实名认证要求，您可以拒绝提供，但将可能无法使用实名用户相关服务（如开播、佣金提现），但不影响您正常使用其他功能或服务。\n'+
              ...
              '（1）您使用贵仁昌益时的操作行为信息，包括您在访问/使用贵仁昌益时的点击、关注、订阅、搜索、浏览、点赞、评论、发布、分享及打赏交易的操作相关记录，以及您自主填写的性别、生日、地区等个人资料信息；\n'+
              '我们会根据您在使用贵仁昌益过程中的操作行为，不断调整优化推荐结果，以便更好地向您提供优质内容。请您知悉，除取得您另行授权或法律法规另有规定外，贵仁昌益的个性化推荐机制不会与用户身份信息相结合，以确保不识别到特定自然人的真实身份。\n'+
              ...
              '8.3邀请互动、分享互动、福利礼包互动\n'+
              '在您邀请或接受邀请信息、分享或接收被分享的信息、参加福利或礼包活动时，在使用邀请按钮、使用分享按钮、启动贵仁昌益APP、点击领取福利或礼包的场景下，贵仁昌益客户端需要在本地访问你的剪切板，用于写入、读取其中对应包含的邀请码、分享码、口令、链接，以实现邀请、分享、福利或礼包领取、跳转至用户活动页、活动联动等功能或服务。我们仅在本地识别出剪切板内容属于上述功能或服务有关的指令时才会将其上传我们的服务器。除此之外，贵仁昌益客户端不会上传你剪切板的其他信息至我们的服务器。另外，我们可能需要获取存储/相册权限以便于你分享或接收被分享的视频和图片。\n'+
              '8.4直播间互动\n'+
              '您理解并知悉，贵仁昌益并非私密空间。当您在贵仁昌益间互动时，您的昵称、头像、互动信息（包括但不限于弹幕、评论、送礼等信息）将在直播间内公开展示，同时我们会根据用户的互动活跃情况形成直播间内的统计数据（例如榜单、排名等）并公开展示。\n'+
              '8.5系统权限使用说明\n'+
              '（1）基于相机/摄像头的业务功能。您可在开启相机/摄像头权限后使用云豹的扫描二维码、视频直播和拍摄功能，以及在特定场景下经您授权的人脸识别等功能。当您使用该业务功能进行人脸识别时我们会收集您的面部特征，且严格在经您授权同意的范围内使用，未来如我们拟使用您的面部信息为您提供其他产品及/或服务功能的，我们会再次与您确认。当您通过iOS系统使用贵仁昌益的开播组件时，我们可能会使用ARKit和TrueDepth API中的人脸映像深度相关信息的计算结果，用于美颜、特效滤镜、贴纸、虚拟形象等功能以达到更好的人脸处理效果；在此期间，我们既不会将该等运作结果用于其他目的，也不会上传或存储至服务器。\n'+
              ...
              '（4）此外，我们在提供产品或服务的过程中，还可能需要向您申请其他设备权限，您查看并了解贵仁昌益申请的权限详情。这些权限均不会默认开启，只有经过您的明示授权才会在为实现特定功能或服务时使用，您可以通过贵仁昌益APP，管理您对相关权限的授权。特别需要指出的是，即使经过您的授权，我们获得了这些敏感权限，也不会在相关功能或服务不需要时而收集您的信息。\n'+
              '（九）其他合法性事由\n'+
              ...
              '4、Cookie的清除\n'+
              '大多数浏览器均为用户提供了清除浏览器缓存数据的功能，您可以在浏览器设置功能中进行相应的数据清除操作；您也可以管理和清除移动设备上由贵仁昌益APP保存的所有cookie（路径：登录贵仁昌益APP，进入“我的”→ （设置按钮）→清除缓存）。如您进行清除，您可能无法使用由我们提供的、依赖于Cookie的个性化推荐服务及其他相应功能。\n'+
              '三、我们如何共享、转让、公开披露个人信息\n'+
              '（一）共享\n'+
              '为了向您提供更完善、优质的产品和服务，我们可能会与第三方合作伙伴共享您的某些个人信息。我们严格遵循合法正当、最小必要、确保安全的原则共享您的个人信息。对共享信息的合作方，我们会与其订立专门的数据保护协议，要求其按照我们的说明、本隐私政策以及其他任何相关的保密和安全措施来处理个人信息。您可以通过贵仁昌益APP【设置】-【第三方数据共享清单】查阅我们如何与第三方共享您的个人信息。通常我们会在以下场景共享个人信息：\n'+
              '1、与第三方SDK共享：为保障贵仁昌益APP相关功能或服务的实现，我们接入了第三方SDK服务。如您在我们平台上使用这类由第三方提供的服务时，您同意将由其收集和处理您的信息（如以嵌入代码、插件等形式）。前述服务商收集和处理个人信息等行为遵守其自身的隐私政策，而不适用于本政策。为了最大程度保障您的信息安全，我们强烈建议您在使用任何第三方SDK类服务前先行查看其隐私政策。为保障您的合法权益，如您发现该等SDK或其他类似的应用程序存在风险时，建议您立即终止相关操作并及时与我们取得联系。您可以查看贵仁昌益查看并了解其处理您个人信息的情况。\n'+
              '2、与关联公司共享：为便于我们基于云豹或关联公司的账号向您提供一致化的产品和服务，在云豹或云豹关联公司的多个产品中（例如贵仁昌益、云豹嗨玩版、云豹助手、云豹手游、小鹿电竞、yowa云游戏等）方便您使用统一账号注册登录，向您推荐您可能感兴趣的内容和信息，保护云豹或云豹关联公司用户的账号及财产安全，您的账号信息、实名认证信息、设备和日志信息可能会与我们的关联公司共享。我们只会共享必要的个人信息，且受本隐私政策中所声明目的的约束，如果我们变更个人信息使用及处理目的，将再次征求您的授权同意。\n'+
              '3、与授权合作伙伴共享：\n'+
              ...
              '六、管理您的个人信息\n'+
              '贵仁昌益非常重视用户的个人信息权益，并尽全力保障您对自己个人信息享有的各项法定权利，以便您拥有充分的能力保障您的信息安全。\n'+
              '注销账号\n'+
              '您可以通过以下方式注销自己的账号：\n'+
              '1、登录贵仁昌益APP，进入“我的”→“设置”→“注销账号”；\n'+
              ...
              '（六）访问和要求解释隐私政策\n'+
              '我们将在您首次开启、注册和登录贵仁昌益APP时，向您提示本隐私政策并由您自主作出选择同意的决定。另外，您可以通过“设置”→“隐私设置”→“隐私协议”页面随时查看本隐私政策的全部内容。\n'+
              '（七）有权获得停止运营的告知\n'+
              ...
              '八、隐私政策更新\n'+
              '1、为给您提供更好的服务以及随着云豹业务的发展，本隐私政策也会随之更新，该等更新构成本隐私政策一部分。但未经您明确同意，我们不会削减您依据本隐私政策所应享有的权利。我们将在更新后的本隐私政策生效前，通过显著位置提示或向您发送推送消息或以其他方式通知您，也请您访问贵仁昌益以便及时了解最新的隐私政策。如该等更新造成您在本隐私政策下权利的实质减少或重大变更，我们会再次征求您的明示同意。\n'+
              '您需理解，只有在您确认并同意变更后的《贵仁昌益隐私政策》，我们才会依据变更后的隐私政策收集、使用、处理和存储您的个人信息；您有权拒绝同意变更后的隐私政策，但请您知悉，一旦您拒绝同意变更后的隐私政策，可能导致您不能或不能继续完整使用贵仁昌益的相关服务和功能，或者无法达到我们拟达到的服务效果。\n'+
