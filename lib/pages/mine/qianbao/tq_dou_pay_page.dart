...
class TQDouPayPage extends StatefulWidget {
  String shuliang;
  TQDouPayPage({Key? key, required this.shuliang}) : super(key: key);

  @override
  State<TQDouPayPage> createState() => _TQDouPayPageState();
}

class _TQDouPayPageState extends State<TQDouPayPage> {
  var appBar;
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: Stack(
                      alignment: Alignment.bottomRight,
                      children: [
                        WidgetUtils.showImagesFill('assets/images/mine_wallet_tqdbj.png', ScreenUtil().setHeight(250), double.infinity),
                        Row(
                          children: [
