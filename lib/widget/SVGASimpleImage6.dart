...
class SVGASimpleImage6 extends StatefulWidget {
  final String? resUrl;
  final String? assetsName;

  const SVGASimpleImage6({Key? key, this.resUrl, this.assetsName})
      : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _SVGASimpleImage6State();
  }
}

class _SVGASimpleImage6State extends State<SVGASimpleImage6>
  ...
  void initState() {
    ...
    animationController!.addListener(() {
      if(animationController!.isCompleted){
        eventBus.fire(RoomGZSVGABack(isOK: true));
      }
    });
    _tryDecodeSvga();
  }
  ...
  @override
  void didUpdateWidget(covariant SVGASimpleImage6 oldWidget) {
